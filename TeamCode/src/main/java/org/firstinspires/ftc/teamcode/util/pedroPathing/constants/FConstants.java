...
public class FConstants {
    static {
        ...
        FollowerConstants.xMovement = 80.55;
        FollowerConstants.yMovement = 63.472;

        FollowerConstants.forwardZeroPowerAcceleration = -60.902;
        FollowerConstants.lateralZeroPowerAcceleration = -87.392;

        FollowerConstants.translationalPIDFCoefficients = new CustomPIDFCoefficients(0.27,0,0.01,0);
        ...
        FollowerConstants.drivePIDFCoefficients = new CustomFilteredPIDFCoefficients(0.009,0,0,0.6,0);
