...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = -2229.1470980856875; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 2249.6280532491955; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = -697.9959074718316; // x position of the perpendicular encoder (in tick units)
    }
