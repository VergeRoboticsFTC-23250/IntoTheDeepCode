...
public class Robot {
    ...
    public static StatePositions outtakeSubmersible = new StatePositions(0.05, 0.85, false, 1350, State.OUTTAKE_SUBMERSIBLE);
    public static StatePositions outtakeSubmersibleScore = new StatePositions(0.05, 0.85, false, 1500, State.OUTTAKE_SUBMERSIBLE_SCORE);
